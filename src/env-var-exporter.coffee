...
class EnvVarExporter
    ...
    @getShellCommands: ->
        ...
        envCommands = @loadCircleCIEnvVars(packageJSON)

        for envName, value of envs
            envCommands.push "export #{envName}=\"#{value}\""

        return envCommands.join('\n')
